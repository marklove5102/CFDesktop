# =============================================================================
# CI Build Toolchain Configuration (aarch64/ARM64)
# =============================================================================
# 专用工具链文件，用于 Docker 容器内的 aarch64 CI 构建
#
# Qt 安装路径: /opt/Qt/6.8.1/gcc_arm64
#
# 使用方式：
...
# -----------------------------------------------------------------------------
# Qt6 搜索路径（aarch64 容器环境）
# Docker 容器通过 aqtinstall 安装 Qt 到 /opt/Qt/6.8.1/gcc_arm64
# -----------------------------------------------------------------------------
set(QT6_BASE_DIR "/opt/Qt/6.8.1/gcc_arm64")
